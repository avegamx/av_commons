...
public class SendMail2 {
	...
	private static org.apache.log4j.Logger logger = Logger.getLogger(SendMail2.class);	
	...
	public SendMail2(Properties props){
	...
	private Session getSession() { 
		...
		props.setProperty("mail.smtp.auth", properties.getProperty("auth","true"));
		props.setProperty("mail.smtp.host", properties.getProperty("host","10.0.0.1")); 
		props.setProperty("mail.smtp.port", properties.getProperty("port","25")); 
	...
	private class Authenticator extends javax.mail.Authenticator { 
		...
		public Authenticator() { 
			...
			String username = properties.getProperty("username","username@mail.com"); 
